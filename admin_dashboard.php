...
<div class="sidebar">
   ...
   <div class="home_content">
    <!-- <div class="nav"></div> -->
     <div id="dashboard" class="text">Admin Dashboard</div>
 ...
 error_reporting(0);
   if($res-> num_rows>0) {
    while($row = $res->fetch_assoc()){
      $key= $row["stationID"];
      echo ("<tr><td>" . $row["station_name"] . "</td><td>" . $row["station_contact"] . "</td><td>" . $row["stationArea"] . "</td><td>". "<a href=QR..php?key=$key.>QR</a>"."</td></tr>");
    }
  }
      ?>
